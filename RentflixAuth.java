...
public class RentflixAuth extends JFrame {
    ...
    // Helper method to open the main app window
    private void openRentflixApp() {
        SwingUtilities.invokeLater(() -> {
            try {
                ...
                t.printStackTrace();
                showErrorDialog("Unable to open RentflixApp: " + t.getMessage());
            }
        });
    }
    ...
    // Color scheme - matching Netflix dark theme
    ...
    private JPanel createSignupPanel() {
        ...
        studentFieldsPanel.add(createLabel("College Email (for verification)"));
        ...
        studentFieldsPanel.add(Box.createRigidArea(new Dimension(0, 18)));
        ...
        landlordFieldsPanel.add(Box.createRigidArea(new Dimension(0, 18)));
...
private void handleLogin(JComboBox<String> loginTypeCombo) {
    ...
    private void handleSignup() {
        ...
        SwingWorker<Void, Void> worker = new SwingWorker<Void, Void>() {
            ...
            protected void done() {
                ...
                openRentflixApp(); // Open main application
            }
        };
        worker.execute();
    }
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            RentflixAuth frame = new RentflixAuth();
