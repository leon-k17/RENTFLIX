...
private void initComponents() {
    ...
    // Decide which left component to use (imagePanel or gradient)
    ...
    JLabel landlordLabel = new JLabel("Landlord: " + 
        (property.getLandlordName() != null ? property.getLandlordName() : "Contact for details"));
    ...
    // Add left and center to content panel
    contentPanel.add(leftImageComponent, BorderLayout.WEST);
    contentPanel.add(detailsPanel, BorderLayout.CENTER);

    // Put contentPanel inside mainPanel so scrolling works
